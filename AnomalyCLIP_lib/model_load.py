...
def _download(
    ...
    if not cache_dir:
        ...
        cache_dir = os.path.expanduser("/data/LiuYuyao/Project/WinVL/AnomalyCLIP_lib/")
...
def load(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", design_details = None, jit: bool = False, download_root: str = None):
    ...
    if name in _MODELS:
        ...
        model_path = _download(_MODELS[name], download_root or os.path.expanduser("/data/LiuYuyao/Project/ACAC/AnomalyCLIP_lib/"))
