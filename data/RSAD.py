...
class RSADSolver(object):
    CLSNAMES = [
    # 'mild_disease', 'moderate_disease', 'severe_disease', 'mix_disease'
    # '01'
    'TS'
    ]
...
if __name__ == '__main__':
    runner = RSADSolver(root='/data/LiuYuyao/Dataset/Railway_anomaly_detection/Track_Scene/')
    runner.run()
